  ...
  return (
    <>
        <div  className='margin-bottom-2 margin-top-2'>
            <NextLink href={previousScreen("NDCNumber", userData)} passHref legacyBehavior><Link variant="nav">&lt; Back</Link></NextLink>
        </div>
        ...
        <div  className='margin-bottom-2 margin-top-2'>
            <NextLink href={nextScreen("NDCNumber", userData)} passHref legacyBehavior><Link variant="nav">Skip this step</Link></NextLink>
        </div>
        <div style={{width: '100%', textAlign: 'center'}}>
            <NextLink href={nextScreen("NDCNumber", userData)} passHref legacyBehavior><Link className="usa-button padding-left-6 padding-right-6" variant="unstyled" allowSpacebarActivation>Save and continue</Link></NextLink>
        </div>
    </>
  );
}
