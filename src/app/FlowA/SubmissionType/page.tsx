...
import { Checkbox, Fieldset, Link, ErrorMessage, FormGroup } from "@trussworks/react-uswds";
  ...
  return (
    <>
        ...
        <div style={{width: '100%', textAlign: 'center'}}>
            <NextLink href={nextScreen("SubmissionType", userData)} passHref legacyBehavior><Link onClick={validate} className="usa-button padding-left-6 padding-right-6" variant="unstyled" allowSpacebarActivation>Save and continue</Link></NextLink>
        </div>
    </>
  );
}
